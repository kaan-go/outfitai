...
export default function Signup() {
  ...
  useEffect(() => {
    if (user) navigate('/avatar-setup', { replace: true })
  }, [user, navigate])
  ...
  const handleGoogleSignup = async () => {
    const { error } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: { redirectTo: `${window.location.origin}/avatar-setup` },
    })
      ...
      <div className="min-h-screen flex items-center justify-center px-4 bg-surface pt-16">
        <div className="w-full max-w-md text-center">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <p className="text-gray">We sent a confirmation link to <strong className="text-dark">{email}</strong>. Click it to activate your account.</p>
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray mt-1">Start generating outfits today</p>
          </div>
